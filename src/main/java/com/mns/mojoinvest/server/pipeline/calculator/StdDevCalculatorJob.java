...
public class StdDevCalculatorJob extends Job1<String, Integer> {

    private static final Logger log = Logger.getLogger(StdDevCalculatorJob.class.getName());
    ...
    public Value<String> run(Integer period) {
        ...
        cvDao.put("STDDEV|" + period, cvs);

        return immediate("Finished STDDEVCalculator for " + period);
