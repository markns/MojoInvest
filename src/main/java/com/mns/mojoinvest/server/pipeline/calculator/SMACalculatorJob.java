...
public class SMACalculatorJob extends Job1<String, Integer> {

    private static final Logger log = Logger.getLogger(SMACalculatorJob.class.getName());
    ...
    public Value<String> run(Integer period) {
        ...
        cvDao.put("SMA|" + period, cvs);

        return immediate("Finished SMACalculator for " + period);
