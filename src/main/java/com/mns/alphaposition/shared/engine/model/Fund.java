package com.mns.alphaposition.shared.engine.model;
...
public class Fund implements Comparable<Fund> {
    ...
    public boolean equals(Object o) {
        ...
        if (aum != null ? !aum.equals(fund.aum) : fund.aum != null) return false;
        if (averageVol != null ? !averageVol.equals(fund.averageVol) : fund.averageVol != null) return false;
        if (category != null ? !category.equals(fund.category) : fund.category != null) return false;
        if (expenseRatio != null ? !expenseRatio.equals(fund.expenseRatio) : fund.expenseRatio != null) return false;
        ...
        if (symbol != null ? !symbol.equals(fund.symbol) : fund.symbol != null) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (aum != null ? aum.hashCode() : 0);
        result = 31 * result + (expenseRatio != null ? expenseRatio.hashCode() : 0);
        result = 31 * result + (inceptionDate != null ? inceptionDate.hashCode() : 0);
        result = 31 * result + (averageVol != null ? averageVol.hashCode() : 0);
        return result;
    }
}
