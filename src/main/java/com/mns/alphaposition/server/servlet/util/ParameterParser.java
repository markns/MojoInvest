...
package com.mns.alphaposition.server.servlet.util;
...
public class ParameterParser {
    ...
    public LocalDate getLocalDateParameter(String name)
            throws ParameterNotFoundException {
        return new LocalDate(getStringParameter(name));
    }

    public LocalDate getLocalDateParameter(String name, LocalDate def) {
        try {
            return getLocalDateParameter(name);
        } catch (ParameterNotFoundException e) {
            return def;
        }
    }
     ...
     *
     * @param required an array of required parameters
