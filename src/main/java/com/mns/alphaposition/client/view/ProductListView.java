...
package com.mns.alphaposition.client.view;
 ...
 */
public class ProductListView extends ViewImpl implements ProductListPresenter.MyView {
...
//                    ProductPresenter.TOKEN_ID, Integer.toString(product.getId()));
            productList.add(new Label(product.getName()));
        }
    }
